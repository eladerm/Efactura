 ...
 *
 * @param {string|number} val Valor a completar
 * @param {number} len Longitud final
 * @return {string} Valor con padding
 */
...
/**
 * Genera clave de acceso SRI.
 *
 * @param {string} fecha Fecha ddmmyyyy
 * @param {string} codDoc Código de documento
 * @param {string} ruc RUC emisor
 * @param {string} ambiente Ambiente SRI
 * @param {string} estab Establecimiento
 * @param {string} ptoEmi Punto de emisión
 * @param {string} secuencial Secuencial
 * @param {string} codigoNum Código numérico
...
/**
 * Genera XML de factura con claveAcceso.
 *
 * @return {void}
 */
